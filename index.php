          ...
          <div class="card-body p-md-5">
            <div class="row justify-content-center">
                ...
                <form action="" class="mx-1 mx-md-4" method="POST">
                  ...
                  <div class="d-flex flex-row align-items-center mb-4">
                    ...
                    <div class="form-outline flex-fill mb-0">
                      ...
                      <label class="form-label" for="inputPassword">Repeat your password</label>
                    </div>
                  </div>

                  <div class="form-check">
                    <input class="form-check-input" type="checkbox" value="" id="gridCheck" />
                    <label class="form-check-label" for="gridCheck"> I agree all statements in <a href="#!">Terms of service</a></label>
                  </div>
              ...
              <div class="col-md-10 col-lg-6 col-xl-7 d-flex align-items-center order-1 order-lg-2">
                ...
                <img src="https://image.freepik.com/free-vector/hand-drawn-clothing-donation-concept_52683-54708.jpg" class="img-fluid" alt="Sample image">

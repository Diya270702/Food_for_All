...
.news{
    background:linear-gradient(rgba(255,255,255,.5),rgba(255,255,255,.5)), url(https://static.vecteezy.com/system/resources/previews/002/007/760/original/abstract-summer-and-spring-trendy-artistic-background-template-vector.jpg) no-repeat;
...
<section class="news" id="news">
    ...
    <h1 class="heading"> our <span>newsroom</span></h1>
    
    <div class="box-container">
    
        <div class="box" data-aos="fade-right">
            <img src="https://static.wixstatic.com/media/1ede0ddbc0b64ae19c06ae2cae61653c.jpg/v1/fit/w_924,h_520/1ede0ddbc0b64ae19c06ae2cae61653c.jpg" alt="">
            <h3>Exclusive Interview With Founder Of Local Charity</h3>
            <div class="date">January 12, 2005</div>
            <a href="#"><button class="btn">Read More</button></a>
        </div>
    
        <div class="box" data-aos="fade-left">
            <img src="https://static.wixstatic.com/media/bd19bfcbfc81485c9750d908550c6609.jpg/v1/fit/w_924,h_520/bd19bfcbfc81485c9750d908550c6609.jpg" alt="">
            <h3>Local Foundation Marks Special Anniversary</h3>
            <div class="date">July 27, 2007</div>
            <a href="#"><button class="btn">Read More</button></a>
        </div>
    
        <div class="box" data-aos="fade-right">
            <img src="https://as1.ftcdn.net/v2/jpg/03/52/46/50/1000_F_352465056_lLNu4h0QBZg3ohTlUopcaqEvdR9OutBV.jpg" alt="">
            <h3>How To Choose The Perfect Charity</h3>
            <div class="date">October 7, 2015</div>
            <a href="#"><button class="btn">Read More</button></a>
        </div>
    
        <div class="box" data-aos="fade-left">
            <img src="https://image.freepik.com/free-photo/close-up-hands-holding-food_23-2149196108.jpg" alt="">
            <h3>Our Recent Drive Hit Over 1,000 Donations</h3>
